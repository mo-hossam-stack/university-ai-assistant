  ...
  return (
    <div className="flex flex-col h-full bg-background">
      {hasMessages && !showWelcome && (
        <div className="flex items-center justify-between px-4 py-2 border-b border-border/60 backdrop-blur-md bg-card/80 flex-shrink-0">
          <Button
            variant="ghost"
            size="sm"
            onClick={handleBack}
      ...
      <div className="flex-shrink-0 border-t border-border/60 backdrop-blur-md bg-card/80 px-4 py-3 safe-area-bottom">
